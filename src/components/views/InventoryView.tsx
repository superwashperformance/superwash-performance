        ...
        <>
          ...
          <div className="flex items-center justify-between gap-4">
            <input
              ...
              className="w-full max-w-md bg-white border border-slate-200 rounded-xl px-4 py-2.5 text-xs text-slate-900 focus:border-[#7A1B28] outline-none"
            />
          ...
          <div className="glass-card p-4 overflow-x-auto">
            <table className="w-full text-left text-xs text-slate-700">
              <thead className="bg-slate-50 font-display text-sm tracking-wider uppercase text-slate-500 border-b border-slate-200">
                <tr>
                      ...
                      <td className="p-3 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="w-7 h-7 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold flex items-center justify-center border border-slate-200 transition-colors"
        ...
        <>
          ...
          <div className="glass-card p-4 overflow-x-auto border-purple-200 shadow-[0_0_30px_rgba(168,85,247,0.05)]">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-display text-lg text-slate-800 uppercase tracking-wider flex items-center gap-2">
