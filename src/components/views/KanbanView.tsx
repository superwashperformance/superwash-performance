...
export const KanbanView: React.FC<KanbanViewProps> = ({
  ...
  const columns: { id: ODSStatus; label: string; color: string }[] = [
    ...
    { id: 'delivered', label: '9. ENTREGADO', color: 'border-slate-600 text-slate-500' },
  ];
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto flex flex-col gap-3 pr-1">
                {colOrders.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-32 border border-dashed border-slate-200 rounded-xl text-center p-4">
                        ...
                        <div className="flex items-center justify-between gap-1 pt-1" onClick={(e) => e.stopPropagation()}>
                          ...
                          {col.id === 'delivered' ? (
                            <button
                              ...
                              className="px-2.5 py-1 rounded-lg bg-emerald-500 text-slate-900 font-display text-xs font-bold hover:bg-emerald-400 flex items-center gap-1 transition-colors ml-auto shadow-md"
